...
<?php $_SESSION['SESS_LANGUAGE']?> = item;
...
$result = mysqli_query($con,"select c.name as custname,c.address,p.name as prodname,o.quantity,o.odate from orders o join customers c on c.cid=o.cid join products p on p.pid=o.pid");
?>
